...
I run [[https://github.com/d12frosted/homebrew-emacs-plus][Emacs plus]] installed via Homebrew with the following options:
+ ~--with-native-comp~
...
is just plain ugly. I like the [[https://github.com/be5invis/Iosevka][Iosevka]] font in a large size, and I like to show
a little company pride with my splash image. Line numbers are a must, and I
