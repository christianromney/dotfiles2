...
Create.detailed_help = {
    ...
    'DESCRIPTION': """\
        *{command}* facilitates the creation of Google Compute Engine
        virtual machines. For example, running:
          ...
          $ {command} INSTANCE-1 INSTANCE-2 INSTANCE-3 --zone us-central1-a

        will create three instances called 'INSTANCE-1',
        'INSTANCE-2', and 'INSTANCE-3' in the ``us-central1-a'' zone.
    ...
    'EXAMPLES': """\
        ...
        6'' image available, run:
          ...
          $ {command} INSTANCE --image rhel-6 --zone us-central1-a
        """,
}
