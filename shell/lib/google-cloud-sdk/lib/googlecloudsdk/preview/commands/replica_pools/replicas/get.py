...
class Get(base.Command):
  """Gets detailed information about a single replica in a replica pool."""
...
Get.detailed_help = {
    'brief': 'Gets information about a single replica in a replica pool.',
    'DESCRIPTION': """\
        This command gets information about a single replica in a replica pool.
