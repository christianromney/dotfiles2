#!/usr/bin/env bash
# My fork of https://github.com/paulirish/dotfiles/blob/master/.osx
#
...
# keyboard settings
defaults write NSGlobalDomain AppleKeyboardUIMode -int 2 # research 3

# Disable press-and-hold for keys in favor of key repeat
defaults write NSGlobalDomain ApplePressAndHoldEnabled -bool false
defaults write NSGlobalDomain KeyRepeat -int 1 # was 2
defaults write NSGlobalDomain InitialKeyRepeat -int 10 # was 15


# Increase window resize speed for Cocoa applications
defaults write NSGlobalDomain NSWindowResizeTime -float 0.10
...
# Hide all desktop icons because who needs 'em'
